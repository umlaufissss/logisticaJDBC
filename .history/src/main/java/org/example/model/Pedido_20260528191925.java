...
public class Pedido 
{
    ...
    public Pedido(Cliente cliente, LocalDate data_pedido, double volume_m3, double peso_kg, double valor_frete,
            enumPedidos status) {
        this.cliente = cliente;
        this.data_pedido = data_pedido;
        this.volume_m3 = volume_m3;
    ...
    public String toString() {
        return "Pedido [id=" + id + ", cliente=" + cliente + ", data_pedido=" + data_pedido + ", volume_m3=" + volume_m3
                + ", peso_kg=" + peso_kg + ", valor_frete=" + valor_frete + ", status=" + status + "]";
    }
