...
public class ViewAtualizarStatus extends Main
{
    ...
    {
        int entrega_id, opcao, novoStatus, status;
        boolean valido = true;
        ...
        {
            switch (novoStatus) {
                case 1 -> status = "EM_ROTA";
                case 2 -> status = "ENTREGUE";
                case 3 -> status = "CANCELADO";
                case 4 -> status = "ATRASADA";
            }

            mandar
        }

        FAZER FUNÇÃO DE ALTERAR PEDIDO + FINALIZAR DATAS + AUTOMATIZAR HISTÓRICO DE ENTREGAS PARA DESCRICAO DE ENTREGUE
            */
