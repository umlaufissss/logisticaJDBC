...
public class EntregaDao 
{
    ...
    public static void excluirEntrega(int id) throws SQLException
    {
        String sqlVerificar = """
        ...
        try(Connection conn = ConnectionFactory.Conexao())
        {
            PreparedStatement stmtVerificar = conn.prepareStatement(sqlDeletar);
            ...
            {
                System.out.println("Erro! Não é possível apagar entregas finalizadas!");                throw new RuntimeException("Erro! Não é possível apagar entregas finalizadas!");
            }
            else
            {
                PreparedStatement stmtDeletar = conn
            }
        }
    }
}
